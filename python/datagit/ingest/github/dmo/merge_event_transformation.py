...
class MergeEventTransformation(BaseObject):
    """ Transform GitHub Merge Events into the Cendant Field Structure """
    ...
    def __init__(self,
        ...
        Created:
            6-Dec-2019
            craig.trim@ibm.com
            *   https://github.ibm.com/GTS-CDO/unstructured-analytics/issues/1537
        :param issue_id:
    ...
    def process(self) -> list:
        ...
        def created_at():
            return self._svcresult["author"]["date"].split('T')[0].strip()

        def open_by():
            return self._svcresult["author"]["name"].strip()

        def message():
            return self._svcresult["message"]

        def tree_url():
            return self._svcresult["tree"]["url"]
