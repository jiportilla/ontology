...
class AssignmentTransformation(BaseObject):
    """ Transform GitHub Assignments into the Cendant Field Structure """
    ...
    def __init__(self,
        ...
        Created:
            3-Dec-2019
            craig.trim@ibm.com
            *   https://github.ibm.com/GTS-CDO/unstructured-analytics/issues/1509#issuecomment-16373132
        :param issue_id:
    ...
    def process(self) -> list:
        ...
        def assignee():
            return self._svcresult["assignee"]["login"].strip()

        def assigner():
            return self._svcresult["assigner"]["login"].strip()
        ...
        if self._is_debug:
            self.logger.debug('\n'.join([
                "Assignment Tranformation Complete",
